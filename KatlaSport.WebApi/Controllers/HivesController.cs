...
namespace KatlaSport.WebApi.Controllers
{
    ...
    public class HivesController : ApiController
    {
        ...
        [SwaggerResponse(HttpStatusCode.Conflict, Description = "Conflict")]
        [SwaggerResponse(HttpStatusCode.InternalServerError, Description = "InternalServerError")]
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Description = "BadRequest")]
        [SwaggerResponse(HttpStatusCode.Conflict, Description = "Conflict")]
        [SwaggerResponse(HttpStatusCode.NotFound, Description = "NotFound")]
        [SwaggerResponse(HttpStatusCode.InternalServerError, Description = "InternalServerError")]
